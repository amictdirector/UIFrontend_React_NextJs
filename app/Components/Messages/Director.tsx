            ...
            <Grid container key={'key_grid_container'} marginBottom={'10px'} bgcolor={''} height={'100%'} size={12} justifyContent={'space-between'} sx={{ padding: { xs: '5px', sm: '5px', md: '10px' } }} >
                <Grid key={'key_grid_about_text'} marginTop={{ md: '10px', lg: '50px' }} fontSize={{
                    ...
                    <Typography sx={{
                        ...
                        {textData.messageFromDirector}<br />
                    </Typography>

                    <br />
                    <Typography textAlign={'justify'}>{textData.messageDirectorOverview}</Typography >
                </Grid>
                <Grid key={'key_grid_about_director'}
                    size={{ xs: 12, sm: 12, md: 6 }}
                    bgcolor={''}
                    sx={{
                        background: '',
                    ...
                    >
                        <Box key={'key_box_dir_pic'}
                            sx={{
                                ...
                                borderRadius: '200px',
                                backgroundImage: `url(${textData.messageDirectorPicPath})`,
                                backgroundRepeat: 'no-repeat',
                                backgroundPosition: 'center',
                        ...
                        <Box color={'white'} fontSize={{
                            ...
                            <Typography fontStyle={'italic'}>{textData.aboutUsDirectorQuotes}</Typography>
