        ...
        <>
            <Grid container key={'key_grid_container'} marginBottom={'10px'} bgcolor={''} height={'100%'} size={12} justifyContent={'space-between'} sx={{ padding: { xs: '5px', sm: '5px', md: '10px' } }} >
                <Grid key={'key_grid_about_text'} marginTop={{ md: '10px', lg: '50px' }} fontSize={{
                    ...
                    <br/>
                    <Typography textAlign={'justify'}>{textData.messageGenSecText}</Typography >
                    <br/>
                     <Typography sx={{ fontSize: { xs: '.75rem', md: '1.5rem' }, fontWeight: 'bold' }}>
                       A & M Institute is a place where growth is a way of life. it is our tradition alive I invite you to be a part of our programmes.
                    </Typography>
                </Grid>
                    ...
                    >
                        <Box key={'key_box_dir_pic'}
                            sx={{
                                ...
                                borderRadius: '200px',
                                backgroundImage: `url(${textData.messageGenSecPicPath})`,
                                backgroundRepeat: 'no-repeat',
                        ...
                        <Box color={'white'} fontSize={{
                            ...
                            {textData.messageGenSecPosition}
                        </Box>
                        <Box color={'white'} fontSize={{
                            xs: '20px',
                            sm: '22px',
                        ...
                        <Box color={'white'} fontSize={{
                           ...
                           <Typography fontStyle={'italic'}>{textData.messageGenSecQuotes}</Typography>
