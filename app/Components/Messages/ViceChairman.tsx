            ...
            <Grid container key={'key_grid_container'} marginBottom={'10px'} bgcolor={''} height={'100%'} size={12} justifyContent={'space-between'} sx={{ padding: { xs: '5px', sm: '5px', md: '10px' } }} >
                <Grid key={'key_grid_about_text'} marginTop={{ md: '10px', lg: '50px' }} fontSize={{
                    ...
                    <Typography sx={{
                        ...
                        {textData.messageFromViceChairman}<br />
                    </Typography>

                    <br />
                    <Typography textAlign={'justify'}>{textData.messageViceChairManText}</Typography >
                </Grid>
                    ...
                    >
                        <Box key={'key_box_dir_pic'}
                            sx={{
                                ...
                                borderRadius: '200px',
                                backgroundImage: `url(${textData.messageViceChairManPicPath})`,
                                backgroundRepeat: 'no-repeat',
                                backgroundPosition: 'center',
                        ...
                        <Box color={'white'} fontSize={{
                            ...
                            {textData.messageViceChairManPosition}
                        </Box>
                        <Box color={'white'} fontSize={{
                            xs: '20px',
                            sm: '22px',
                            ...
                            {textData.messageViceChairManName}
                        </Box>
                        <Box color={'white'} fontSize={{
                            xs: '12px',
                            sm: '14px',
                           ...
                           <Typography fontStyle={'italic'}> {textData.messageViceChairManQuotes}</Typography>
                        </Box>
